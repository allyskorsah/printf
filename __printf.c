 ...
 *Return: number of characteres to be printed
 */
 ...
 *Description: This function makes a loop to string pointer
 *Return: number of characteres to be printed
 */
 ...
 *@aux: character
 *Description: This function prints % pear
...
/**
 * calls_the_function_manager - calls the function manager
